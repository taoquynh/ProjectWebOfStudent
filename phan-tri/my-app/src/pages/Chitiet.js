                        ...
                        <div className="col-12 col-sm-12 col-md-5 col-lg-5 col-xl-5 d-flex flex-column justify-content-around">
                            <div>
                                ...
                                <div className="chi-tiet-dac-diem">
                                    <p className="text1">Đồng hồ {product.gender}</p>
                                    <p className="text1">Loại dây: {product.chain}</p>
                                    <p className="text1">Loại Máy: {product.movement}</p>
                                    <p className="text1">Case size: {product.caseSize}mm</p>
                                    <p className="text1">Kiểu đồng hồ: {product.type}</p>
                                </div>
                            </div>
